...
function StoreInsightModal({
  ...
  const getItemBatchNumber = (item: TransferOrderItem) => item.products?.batchNumber || "-";
      ...
      .map((item, idx) => {
        ...
        return `
          <tr>
            ...
            <td>${escapeHtml(getItemBatchNumber(item))}</td>
                          ...
                          {orderDetails.items.map((item, idx) => {
                            ...
                            return (
                              <TableRow key={idx}>
                                ...
                                <TableCell className="font-mono">{getItemBatchNumber(item)}</TableCell>
